...
### FlashArray
```sh
$ go get github.com/The-Cloud-Source/pure-go-api/flasharray
```
### Pure1
```sh
$ go get github.com/The-Cloud-Source/pure-go-api/pure1
```
...
## FlashArray
https://godoc.org/github.com/The-Cloud-Source/pure-go-api/flasharray
...
import (
	"fmt"
	"github.com/The-Cloud-Source/pure-go-api/flasharray"
)
...
## Pure1
https://godoc.org/github.com/The-Cloud-Source/pure-go-api/pure1
...
import (
	"fmt"
	"os"
	"github.com/The-Cloud-Source/pure-go-api/pure1"
)
